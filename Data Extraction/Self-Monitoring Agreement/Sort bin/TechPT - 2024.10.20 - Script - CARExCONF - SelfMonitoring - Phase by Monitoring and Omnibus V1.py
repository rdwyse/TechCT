...
# Filter datasets for each study phase, including Monitoring6 in calculations
...
columns_to_drop_2_T2 = ['SelfMonitoring1', 'SelfMonitoring2', 'SelfMonitoring6a_1', 'SelfMonitoring6a_2', 'SelfMonitoring6a_3', 'ConfMonitoring1', 'ConfMonitoring2', 'ConfMonitoring6a_1', 'ConfMonitoring6a_2', 'ConfMonitoring6a_3']
df_2_T2 = filter_and_drop(df, '2_T2', columns_to_drop_2_T2)

columns_to_drop_3_T3 = []  # No columns to drop to include all monitoring variables in T3
